...
import 'package:futsal/screens/futsal_profile.dart';
  ...
  Widget _googlemap(BuildContext context) {
    return Container(
      ...
      child: GoogleMap(
        ...
        markers: {khwopaFutsal, shooters, khwopaF, glory},
      ),
    );
  }
      ...
      child: Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              FutsalData futsal = futsals[index];
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => FutsalProfile()),
                  );
...
Marker khwopaF = Marker(
    markerId: MarkerId('KF'),
    position: LatLng(27.671375, 85.440855),
    infoWindow: InfoWindow(title: 'Khwopa'),
    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueGreen));

Marker glory = Marker(
    markerId: MarkerId('SGlory'),
    position: LatLng(27.672058, 85.401287),
    infoWindow: InfoWindow(title: 'SGlory'),
    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueGreen));
